...
export default function RegenerateModal({ isOpen, onClose, onRegenerate }: Props) {
    ...
    const quickTags = [
        t('lessons.regenerate.tag.more_examples', 'More examples'),
        t('lessons.regenerate.tag.more_code', 'More code samples'),
        t('lessons.regenerate.tag.simpler', 'Simpler explanation'),
        t('lessons.regenerate.tag.more_depth', 'More depth'),
        t('lessons.regenerate.tag.shorter', 'Make it shorter'),
        t('lessons.regenerate.tag.fix_errors', 'Fix factual errors'),
    ];
                        ...
                        <div className="p-6 space-y-5">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-headline font-extrabold text-lg text-on-surface">
                                            {t('lessons.regenerate.title', 'Regenerate Lesson')}
                                        </h3>
                                        <p className="text-xs text-on-surface-variant">
                                            {t(
                                                'lessons.regenerate.subtitle',
                            ...
                            <div>
                                <label className="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest mb-2 block">
                                    {t(
                                        'lessons.regenerate.what_should_change',
                                        'What should change?',
                                    )}
                                </label>
                                <textarea
                                    ...
                                    placeholder={t(
                                        'lessons.regenerate.placeholder',
                                        'e.g. Add a hands-on example for the second section, simplify the code, fix the explanation about closures...',
                                    )}
                                />
                                <p className="text-[11px] text-on-surface-variant mt-1.5">
                                    {t(
                                        'lessons.regenerate.optional_hint',
                                        'Optional. Leave empty to regenerate from scratch.',
                                    )}
                                </p>
                            </div>
                            ...
                            <div>
                                <label className="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest mb-2.5 block">
                                    {t(
                                        'lessons.regenerate.quick_adjustments',
                                        'Quick adjustments',
                                    )}
                                </label>
                            ...
                            <div className="flex items-center gap-3 pt-1">
                                ...
                                <motion.button
                                    ...
                                    className="flex-1 py-3 rounded-xl text-sm font-bold text-white bg-primary hover:bg-primary/90 transition-all shadow-md shadow-primary/15 flex items-center justify-center gap-2"
                                >
                                    <Sparkles size={16} />
                                    {t('lessons.regenerate.cta', 'Regenerate')}
                                </motion.button>
                            </div>
                        </div>
                    </motion.div>
